...
export default function ChatAccessDenied() {
  ...
  return (
    <div className="flex flex-col rounded-tl-xl rounded-tr-xl rounded-bl-xl min-w-[370px] max-w-[370px] rounded-br-xl h-screen bg-[#f5f5f5] text-gray-800">
      {/* Header */}
      ...
      {/* Chat Area */}
      <main className="flex-1 overflow-y-auto p-4 flex items-center justify-center min-w-[370px]">
