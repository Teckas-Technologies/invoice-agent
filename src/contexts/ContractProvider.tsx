    ...
    useEffect(() => {
        const initializeContract = async () => {
            try {
                ...
                let detectedProvider: ethers.providers.Web3Provider | null = null;

                if (window.ethereum) {
                    detectedProvider = new ethers.providers.Web3Provider(window.ethereum as any);
                    ...
                    detectedProvider = new ethers.providers.Web3Provider(walletConnectProvider as any);
                }
